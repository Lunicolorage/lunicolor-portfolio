function Vague() {
   const waves = [
    { speed: "22s", delay: "0s", opacity: 1, color: "black", bottom:55 },
    { speed: "22s", delay: "0.2s", opacity: 1, color: "white", bottom: 40 },
    { speed: "16s", delay: "-3s", opacity: 1, color: "black", bottom: -20 },
  ];

  return (
    <div className="vagueConteneur" >
      ...
      {waves.map((w, i) => (
        <svg
          ...
          style={{
            ...
            height: "300px",
            opacity: w.opacity,
            animation: `waveScroll  ${w.speed} linear infinite`,
